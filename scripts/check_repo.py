...
check(manifest.get("browser_specific_settings", {}).get("gecko", {}).get("id") == "pin-mails@elliot.local", "ID public MailPerch modifié")
...
required_root = [
    ...
    "CONTRIBUTING.md", "CODE_OF_CONDUCT.md", "SECURITY.md", "SECURITY_AUDIT_1.0.0.md", "PRIVACY.md", "ROADMAP.md", "SUPPORT.md", "docs/BUG_TRACKER.md",
