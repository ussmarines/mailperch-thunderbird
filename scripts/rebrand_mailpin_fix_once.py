...
# Asset filename references are public/current product surface; repository URLs remain on the historical GitHub slug.
...
print("MailPin targeted localization and asset-reference adjustments complete")
