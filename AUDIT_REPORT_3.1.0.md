...
- L’identifiant de développement `pin-mails@elliot.local` doit rester inchangé pendant les tests afin de préserver les migrations. Choisir l’identifiant public une seule fois avant la première publication.
