...
`pin-mails@elliot.local` est figé comme identifiant public de MailPerch 1.x. Le modifier créerait une seconde installation et séparerait les données existantes ; toute évolution future devra donc conserver cet ID ou fournir une migration explicite.
