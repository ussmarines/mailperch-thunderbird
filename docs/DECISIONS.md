...
`pin-mails@elliot.local` reste utilisé afin que les builds de test mettent à niveau la même installation et conservent les données. L’ID public sera choisi une seule fois avant la première publication.
