...
Produit : **MailPerch — Email Pins & Follow-up**. Build locale : **3.2.1**, ID de développement `pin-mails@elliot.local`.
...
- conservation de l’ID `pin-mails@elliot.local`, du stockage SQLite et de la sécurité multi-fenêtre ;
