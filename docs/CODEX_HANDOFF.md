...
Produit : **MailPerch — Email Pins & Follow-up**. Build locale : **3.1.3**, ID de développement `pin-mails@elliot.local`.
...
- conservation de l’ID `pin-mails@elliot.local`, du stockage SQLite, des migrations et de la sécurité multi-fenêtre ;
