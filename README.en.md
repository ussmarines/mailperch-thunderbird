...
The public product name is **MailPerch**. Historical internal identifiers such as `pin-mails-*` and the development ID `pin-mails@elliot.local` remain unchanged to preserve upgrades and existing local data. See `BRANDING.md`.
