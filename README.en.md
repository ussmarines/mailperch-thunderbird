...
1. Download `MailPerch_v1.5.1.xpi` from release `v1.5.1`.
...
> Internal `3.2.x` development builds used a version number higher than the current public versions. To test `1.5.1` after a development build, use a clean test profile or uninstall the previous build after exporting your MailPerch data.
...
- [1.5.1 security audit](SECURITY_AUDIT_1.5.1.md)
- [1.5.1 validation report](VALIDATION_REPORT_1.5.1.md)
