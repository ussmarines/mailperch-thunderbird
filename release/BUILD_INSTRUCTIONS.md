...
Le build 1.2.1 est conçu pour l’environnement reviewer standard et a besoin uniquement de :
...
```text
dist/MailPerch_v1.2.1.xpi
dist/MailPerch_GitHub_Repository_v1.2.1.zip
dist/SHA256SUMS.txt
```
