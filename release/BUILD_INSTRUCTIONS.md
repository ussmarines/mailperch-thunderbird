...
Le build 1.5.3 est conçu pour l’environnement reviewer standard et a besoin uniquement de :
...
```text
dist/MailPerch_v1.5.3.xpi
dist/MailPerch_GitHub_Repository_v1.5.3.zip
dist/SHA256SUMS.txt
```
