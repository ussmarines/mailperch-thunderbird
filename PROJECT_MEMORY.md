...
> Extension ID public permanent : `pin-mails@elliot.local`
...
7. Conserver définitivement l’ID public `pin-mails@elliot.local` afin de préserver les installations et les données.
